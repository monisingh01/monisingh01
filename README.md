<!-- TOP SECTION (STREAK + STATS FIRST) -->
<h1 align="center">
...
I focus on building **clean, scalable & fast products** with excellent UI/UX.
...
# 🚀 Live Projects  
(Portfolio se directly extracted)

### 🔹 **🎨 Personal Portfolio Website**
✔ React + Tailwind + Animations  
🔗 **Live:** https://moni-portfolio-pi.vercel.app/  
🔗 **Source:** https://github.com/monisingh01/portfolio  

---

### 🔹 **🏦 Banking API (TypeScript – Secure Backend)**
✔ Auth + Transactions + Clean Architecture  
🔗 **Live API:** https://banking-api-ts.vercel.app (if deployed)  
🔗 **Github:** https://github.com/monisingh01/Banking_api  

---

### 🔹 **🛒 Ecommerce Backend (Node + MongoDB)**
✔ JWT Auth  
...
✔ API integration  
🔗 **Live:** https://pixabay-clone.vercel.app (if deployed)  
...
✔ Fun UI  
✔ Clean JS logic  
🔗 **Live:** https://bouncing-ball-game.vercel.app (if deployed)  
